...
fn tint_symbol_25_inner(tint_symbol_26 : vec3u) {
  ...
  if ((x_158 < arrayLength(&(tint_symbol_12.inner)))) {
    ...
    let x_192 = (tint_symbol_27.tint_symbol_9 * (x_186 - tint_symbol_27.tint_symbol_8));
    let x_193 = normalize(x_185);
    let x_194 = (x_182 > 0.0f);
    x_198 = x_194;
    if (x_194) {
      x_197 = (x_184 > 0.0f);
      x_198 = x_197;
    ...
    x_203 = x_198;
    if (x_198) {
      x_202 = (x_186 > 0.00009999999747378752f);
      x_203 = x_202;
    }
    if (x_203) {
      let x_213 = (x_184 * 1000.0f);
      tint_symbol_11.inner[x_169].tint_symbol_3 = (tint_symbol_11.inner[x_169].tint_symbol_3 + ((x_193 * x_192) / vec2f((x_182 * 1000.0f))));
      tint_symbol_11.inner[x_173].tint_symbol_3 = (tint_symbol_11.inner[x_173].tint_symbol_3 - ((x_193 * x_192) / vec2f(x_213)));
    }
  }
  return;
}
...
fn tint_symbol_25_1() {
  let x_228 = tint_symbol_26_1;
  tint_symbol_25_inner(x_228);
  return;
}
...
fn tint_symbol_40_inner(tint_symbol_26_3 : vec3u) {
  var tint_symbol_16 = tint_symbol(vec2f(), vec2f(), vec2f(), 0.0f, 0.0f);
  let x_232 = tint_symbol_26_3.x;
  if ((x_232 < arrayLength(&(tint_symbol_10.inner)))) {
    tint_symbol_16 = tint_symbol_10.inner[x_232];
    if ((tint_symbol_16.tint_symbol_5 != 1.0f)) {
      tint_symbol_11.inner[x_232].tint_symbol_1 = ((tint_symbol_16.tint_symbol_1 + tint_symbol_16.tint_symbol_2) + tint_symbol_11.inner[x_232].tint_symbol_3);
      tint_symbol_11.inner[x_232].tint_symbol_2 = ((tint_symbol_16.tint_symbol_2 + tint_symbol_11.inner[x_232].tint_symbol_3) * 0.94999998807907104492f);
      tint_symbol_11.inner[x_232].tint_symbol_3 = vec2f();
      tint_symbol_11.inner[x_232].tint_symbol_4 = tint_symbol_16.tint_symbol_4;
      tint_symbol_11.inner[x_232].tint_symbol_5 = tint_symbol_16.tint_symbol_5;
    } else {
      tint_symbol_11.inner[x_232] = tint_symbol_16;
    }
  }
  if ((x_232 == 20u)) {
    tint_symbol_11.inner[x_232].tint_symbol_2 = (tint_symbol_11.inner[x_232].tint_symbol_2 + vec2f(0.0f, -0.00100000004749745131f));
  }
  return;
}

fn tint_symbol_40_1() {
  let x_288 = tint_symbol_26_2;
  tint_symbol_40_inner(x_288);
  return;
}
